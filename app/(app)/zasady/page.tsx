    ...
    return(
        <>
            ...
            <ol className="list-decimal px-8 text-base">
                ...
                <ul>
                    <li>Správcem budou zpracovávány Vaše následující osobní údaje: 
                        <ul>
                ...
                <li><span>Účel zpracování</span>
                
                    <ul>
                        <li>Účelem zpracování osobních údajů je plnění právních povinností správce vyplývajících z obsahu uzavřené smlouvy mezi Vámi jako kupujícím a správcem jako prodávajícím, a plnění právních povinností správce vyplývajících z obecně závazných právních předpisů.</li>
                        </ul>
                        </li>
                <li><span>Povinnost poskytnout osobní údaje</span>
                    <ul>
                        <li>Osobní údaje je nezbytné správci poskytnout za účelem plnění práv a povinností vyplývajících z obsahu uzavřené smlouvy.</li>
                    </ul>
                </li>
                <li><span>Doba zpracování</span>
                    <ul>
                        <li>
Osobní údaje mohou být správcem zpracovávány po dobu nezbytnou k plnění práv a povinností vyplývajících z uzavřené smlouvy, případně po dobu nezbytně nutnou k vyřešení sporů majících svůj původ v uzavřené smlouvě.</li>
                    </ul>
                </li>
                <li><span>Poučení subjektu údajů</span>
                    <ul>
                        <li>Společnost HydrooCann Natural s.r.o. informuje své zákazníky, že mají právo:
                            <ul>
