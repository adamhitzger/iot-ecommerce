    ...
    return(
        ...
        <footer className="p-5 rounded-xl grid grid-cols-1 sm:grid-cols-3 gap-10 bg-secondary-foreground  sm:justify-items-center">
            <div className="flex text-lg flex-col">
                <h3 className="text-xl font-bold underline decoration-wavy underline-offset-2">Máte nějaký dotaz ?</h3>
            ...
            <div className="flex text-lg flex-col">
                <h3 className="text-xl font-bold underline decoration-wavy underline-offset-2">Podmínky</h3>
            ...
            <div className="flex text-lg flex-col">
                <h3 className="text-xl font-bold underline decoration-wavy underline-offset-2">Vše o nákupu</h3>
